...
} = __BIM_ADMIN_METADATA__ || {};

const bimDescriptionItems: DescriptionItem[] = [
  {
    content: version,
    title: '版本号',
  },
  ...
  {
    content: h(BimLink, { href: homepage }, { default: () => '点击查看' }),
    title: '主页',
  },
  {
    content: h('div', [
    ...
    <div class="card-box p-5">
      ...
      <div class="mt-4">
        <dl class="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4">
          <template v-for="item in bimDescriptionItems" :key="item.title">
            <div class="border-border border-t px-4 py-6 sm:col-span-1 sm:px-0">
              ...
              <dd class="text-foreground/80 mt-1 text-sm leading-6 sm:mt-2">
                <BimRenderContent :content="item.content" />
              </dd>
            </div>
          </template>
        </dl>
