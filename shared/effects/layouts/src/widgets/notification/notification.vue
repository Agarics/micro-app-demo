  ...
  >
    <template #trigger>
      <div class="flex-center mr-2 h-full" @click.stop="toggle()">
        <BimIconButton class="bell-button relative">
          <span
            v-if="dot"
    ...
    <div class="relative">
      ...
      <BimScrollbar v-if="notifications.length > 0">
      ...
      >
        <BimButton size="sm" variant="ghost" @click="handleClear">
          {{ $t('widgets.clearNotifications') }}
        </BimButton>
        <BimButton size="sm" @click="handleViewAll">
          {{ $t('widgets.viewAll') }}
        </BimButton>
      </div>
    </div>
